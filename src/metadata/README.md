 ...
 * [fix.yml](fix.yml)
     * Determines how your purl.obolibrary.org/obo/fix/ redirects will be handled
     ...
     * Paste in the contents of [fix.yml](fix.yml)
 ...
 * [fix.md](fix.md)
     ...
     * Paste in the contents of [fix.md](fix.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
